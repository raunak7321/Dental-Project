...
const DiscountRefund = () => {
  ...
  const filteredData = invoices.filter((invoice) => {
    // Only include invoices that have a discount greater than 0
    if (invoice.discount <= 0) return false;
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <h2 className="text-3xl font-bold text-teal-700 mb-8">Discount Report</h2>
      ...
      {loading ? (
        <div className="text-center py-8">
          <p className="text-gray-600 text-lg">Loading discount data...</p>
        </div>
      ) : (
        <>
            ...
            {filteredData.length === 0 ? (
              <div className="text-center py-8">
                <p className="text-gray-600">
                  No discount data found for the selected date range.
                </p>
              </div>
            ) : (
          ...
          <div className="flex justify-between items-center mt-6">
            ...
            <div className="bg-white rounded shadow px-6 py-4 text-right">
